 ...
 */
require_once SEGOVIA_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'segovia_register_required_plugins' );
 ...
 */
function segovia_register_required_plugins() {
	/*
    ...
    // Codestar Framework
		array(
			...
			'slug'               => 'cs-framework',
			'source'             => SEGOVIA_FRAMEWORK . '/plugins/cs-framework.zip',
			'required'           => true,
			'version'            => '1.0.1',
		),
		// Contact Form 7
    ...
    array(
	    'name'					=> 'Segovia Core',
	    'slug'					=> 'segovia-core',
			'source'        => 'https://victorthemes.com/plugins/segovia-core.zip',
	    'required'			=> true,
    ),
    // WooCommerce
    array(
