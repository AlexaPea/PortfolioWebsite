...
class vt_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'vt-text-widget',
      VTHEME_NAME_P . __( ': Text Widget', 'segovia' ),
      array(
        'classname'   => 'vt-text-widget',
        'description' => VTHEME_NAME_P . __( ' widget that displays contents.', 'segovia' )
      )
    );
  }
  ...
  public function update( $new_instance, $old_instance ) {
    ...
    $instance['content']    = strip_tags( stripslashes( $new_instance['content'] ), '<p>,<br>,<img>' );
